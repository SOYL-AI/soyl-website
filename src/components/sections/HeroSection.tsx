      ...
      <div className="max-w-content mx-auto px-6 lg:px-16 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
          ...
          <div className="lg:col-span-3">
            <p className="text-mint text-xs tracking-[0.22em] uppercase mb-4 flex items-center gap-3">
              AI-Powered Innovation
              <span className="w-10 h-px bg-mint opacity-40 inline-block" />
            </p>
            <h1 className="font-display font-bold text-soyl-white leading-[1.05] mb-2" style={{ fontSize: 'clamp(52px, 7vw, 96px)' }}>
              SOYL AI
            </h1>
            <h1 className="font-display font-bold text-soyl-white leading-[1.05] mb-3" style={{ fontSize: 'clamp(52px, 7vw, 96px)' }}>
              Private Limited
            </h1>
            <p className="font-display text-mint text-lg md:text-xl mb-6">Story Of Your Life</p>
            <p className="text-graphite max-w-[480px] mb-8">
